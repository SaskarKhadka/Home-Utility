...
class CustomDialogBoxProfile extends StatefulWidget {
  final String prosName;
  final String profession;
  final int phoneNo;
  final String email;
  const CustomDialogBoxProfile(
      this.prosName, this.profession, this.phoneNo, this.email);

  @override
  _CustomDialogBoxProfileState createState() => _CustomDialogBoxProfileState();
}

class _CustomDialogBoxProfileState extends State<CustomDialogBoxProfile> {
