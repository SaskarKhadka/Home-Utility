...
import 'package:home_utility_pro/controllers/requestsDataController.dart';
...
class UserRequestsStream extends StatelessWidget {
  // final requestsDataController = Get.put(RequestsDataController());
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return GetX<RequestsDataController>(
      init: Get.put(RequestsDataController()),
      builder: (requestsDataController) {
        ...
        Map<String, RequestData> userRequests = requestsDataController.data;
        ...
        return Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (userRequests[requestKeys[index]] == null ||
                  userRequests[requestKeys[index]].dateTime == null) {
                return Container();
              }
              RequestData requestData = userRequests[requestKeys[index]];
              // print(requestData);
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                ...
                                requestDataMap['isAccepted'] = true;
              ...
              } else if (index == requestKeys.length - 1 && totalRequests == 0)
                return Center(
                  child: Padding(
                    padding: EdgeInsets.symmetric(
